...
class urban_object:
    ...
    def compute_features(self):
        ...
        #change of curvature
        # change_of_curvature = w[2] / (w[0] + w[1] + w[2] + 1e-10)
        ...
        # compute eigenentropy
        eigenentropy = -np.sum(w_norm * np.log(w_norm + 1e-10))
...
def feature_preparation(data_path):
    ...
    data_header = 'ID,label,linearity,sphericity,verticality,omnivariance,eigenentropy'
...
def backward_feature_selection(X, y):
    ...
    names = ['linearity', 'sphericity', 'verticality', 'omnivariance','eigenentropy']
